...
make Build CCOPTIONS="-fPIC -g -O3 -axSSE2,SSE4.1,SSE4.2" CC=icc CC_LD=icc F77=ifort F77_LD=ifort\
 CTOFLIBS="-lifcore -lifport" FCOPTIONS="-fPIC -g -O3 -axSSE2,SSE4.1,SSE4.2" \
 COPT= FOPT=
